<?php include('server.php');
	...
	if (isset($_POST['ward-consult'])) {
			...
			$sql_status = "SELECT hosp_number FROM ward_consult_records_tb WHERE hosp_number = '$hospitalnumber_var' ";
        ...
        <div class="main-wrapper">
            ...
            <div class="header">
                ...
                <div class="header-left">
                    <a href="ward_consult.php" class="logo">
						...
						<ul>
							...
							<li class="active">
								...
								<ul style="display: none;">
									...
									<li><a href="update_wardconsult.php">Update Ward Consult</a></li>
								</ul>
							</li>
							<li class="submenu">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								...
								<ul class="breadcrumb">
									<li class="breadcrumb-item active">Ward Consult</li><li class="breadcrumb-item active"><a href="update_wardconsult.php" style="color:red;">Update Ward Consult</a></li><li class="breadcrumb-item active"><a href="add_patient_record.php" style="color:red;">Back</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card">
								...
								<div class="card-body">
									<form action="ward_consult.php" method="post">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="available_investigations">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label>Plan</label>
											<input type="text" class="form-control" placeholder="" name="plan">
										</div>
										<div class="form-group">
										...
										<div class="text-center">
											<button type="submit" class="btn btn-primary" name="ward-consult">Submit</button>
										</div>		
									</form>
								</div>
							</div>
