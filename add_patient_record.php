                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								...
								<h4 class="page-title" style="color:#ff0099; font-size: 22px;">Total N<u>o</u> of Patients:
					...
					<div class="row">
							...
							<div class="card dash-widget">
								<div class="card-body">
									...
									<h3>
										...
										<span><a href="elective_surgery.php" style="color:#ff0099; font-size: 19px;">Elective Surgery</a> </span>
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
							<div class="card dash-widget">
								<div class="card-body">
									<span class="dash-widget-icon"><i class="fa fa-ambulance"></i></span>
									<div class="dash-widget-info">
										<h3>
										<?php
										$query = ("SELECT * FROM   emergency_surgery_records_tb" ) or die("could not search");
										...
										<span><a href="emergency_surgery.php" style="color:#ff0099; font-size: 19px">Emergency Surgery</a></span>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card dash-widget">
								<div class="card-body">
									...
									<div class="dash-widget-info">
										...
										<span><a href="ward_consult.php" style="color:#ff0099; font-size: 19px">Ward Consult</a></span>
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
							<div class="card dash-widget">
								<div class="card-body">
									<span class="dash-widget-icon"><i class="fa fa-address-book-o"></i></span>
									<div class="dash-widget-info">
										<h3>
										<?php
										$query = ("SELECT * FROM clinical_records_tb" ) or die("could not search");
										...
										<span><a href="clinical_record.php" style="color:#ff0099; font-size: 19px">Clinical Record</a></span>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card dash-widget">
								<div class="card-body">
									...
									<div class="dash-widget-info">
										...
										<span><a href="unoperated_consult.php" style="color:#ff0099; font-size: 19px">Unoperated Consult Including Dama & Death 1</a> </span>
									</div>
								</div>
							</div>
						</div>
