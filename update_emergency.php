            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">Update Emergency Surgery Record</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item active">Update Emergency Surgery Record</li><li class="breadcrumb-item active"><a href="emergency_surgery.php"  style="color:red;">Back</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<!-- Search Filter -->
					<form action="update_emergency.php" method="post">
                ...
                <!--</form>-->
					<!-- /Search Filter -->
						...
						<?php
								...
								$query = "SELECT * FROM emergency_surgery_records_tb WHERE hosp_number = '$hospitalnumber_var' ";
							...
							<div class="card">
								...
								<div class="card-body">
									<form action="emergency_surgery.php" method="post">
										...
										<div class="form-group">
											<label>PC </label>
											<input type="text" class="form-control" placeholder="" name="pc" value="<?php echo $row['pc']?>"/>
										</div>
										<div class="form-group">
											<label>HX Summary</label>
											<textarea type="text" class="form-control" placeholder="" name=" hx" value="" > <?php echo $row['hx']?> </textarea>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<textarea type="text" class="form-control" placeholder="" name="phy_exam" value="" > <?php echo $row['phy']?> </textarea>
										</div>
										<div class="form-group">
											<label>Available IX</label>
											<input type="text" class="form-control" placeholder="" name="available" value="<?php echo $row['available_ix']?>">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" placeholder="" name="requested_ix" value="<?php echo $row['requested_ix']?>"/>
										</div>
										<div class="form-group">
											<label>Plan</label>
										...
										<div class="form-group">
											...
											<textarea type="text" class="form-control" placeholder="" name="er_care_summary" value="" > <?php echo $row['er_care_summary']?></textarea>
										</div>
										<div class="form-group">
											<label>Surgery Performed</label>
											<input type="text" class="form-control" placeholder="" name="surgery_performed" value="<?php echo $row['surgery_performed']?>">
										</div>
										<div class="form-group">
											<label>IntraOperative Finindings</label>
											<input type="textarea" class="form-control" placeholder="" name="intraop" value="<?php echo $row['intraop']?>" > </input>
										</div>										
										<div class="form-group">
											<label>Date of Surgery</label>
											<input type="date" class="form-control" name="date_surgery" value="<?php echo $row['date_surgery']?>">
										</div>
										<div class="form-group">
											<label>Time of Surgery</label>
											<input type="time" class="form-control" name="time_of_surgery" value="<?php echo $row['time_of_surgery']?>">
										</div>
										<div class="form-group">
											<label>Reason for delay. If any, WHO 3 delay framework</label>
											<textarea type="text" class="form-control" placeholder="" name=" reason_for_delay" value="" > <?php echo $row['reason_for_delay']?></textarea>
										</div>
										<div class="form-group">
											<label>Admission Summary 1</label>
												<textarea type="text" class="form-control" placeholder="" name="admissionsummary1" value=""> <?php echo $row['admission_summary_1']?> </textarea>
										</div>
										<div class="form-group">
											<label>Admission Summary 2</label>
												<textarea type="text" class="form-control" placeholder="" name="admissionsummary2" value="<?php echo $row['admission_summary_2']?>"> <?php echo $row['admission_summary_2']?> </textarea>
										</div>
										<div class="form-group">
											<label>Admisson Summary 3</label>
												<textarea type="text" class="form-control" placeholder="" name="admissionsummary3" value="<?php echo $row['admission_summary_3']?>"> <?php echo $row['admission_summary_3']?> </textarea>
										</div>
										<div class="form-group">
											<label>Complications</label>
												<textarea type="text" class="form-control" placeholder="" name="complication" value="<?php echo $row['complications']?>"> <?php echo $row['complications']?> </textarea>
										</div>
										<div class="form-group">
											<label>Outcomes</label>
												<textarea type="textarea" class="form-control" placeholder="" name="outcomes" value="<?php echo $row['outcome']?>"> <?php echo $row['outcome']?> </textarea>
										</div>
										<div class="form-group">
											<label>Date of Discharge</label>
											<input type="date" class="form-control" name="dateofdischarge" value="<?php echo $row['date_of_surgery']?>"/>
										</div>
										<div class="form-group">
											<label>Length of Hospital Stay</label>
											<input type="test" class="form-control"  name="length_hospital_stay" value="<?php echo $row['total_cost_of_care']?>"/>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label>Date of Surgery</label>
											<input type="date" class="form-control" name="date-of-surgery" value="<?php echo $row['date_of_surgery']?>">
										</div>
										<div class="form-group">
											<label>Total Cost of Care (NGN)</label>
											<input type="number" class="form-control" placeholder="" name="totalcostofcare" value="<?php echo $row['total_cost_of_care']?>">
										</div>
										<div class="form-group">
											<label>Cost of Surgery "<?php echo $row['cost_of_surgery']?>"</label>
											<input type="text" class="form-control" placeholder="" name="costofsurgery" value="<?php echo $row['cost_of_surgery']?>">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" placeholder="" name="fatheroccup" value="<?php echo $row['fatheroccup']?>">
										</div>
										<div class="form-group">
											<label>Mother's Occupation</label>
											<input type="text" class="form-control" placeholder="" name="motheroccup" value="<?php echo $row['motheroccup']?>">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" placeholder="" name="monthlyexpenditure" value="<?php echo $row['monthly_household_expenditure']?>">
										</div>
										<div class="form-group">
											<label>Monthly Income Left After Subsistence Needs Met</label>
											<input type="number" class="form-control" name="monthly-income-left" value="<?php echo $row['monthly_income_left']?>">
										</div>
										<div class="form-group">
											<label>Source of fund for Current Health Expenditure </label>
											<input type="textarea" class="form-control" name="sourceoffund" value="<?php echo $row['source_of_fund']?>">
										</div>
										<div class="form-group">
										...
										<div class="text-center">
											<button type="submit" class="btn btn-primary" name="update_emergency">Update</button>
										</div>										
									</form>
								</div>
							</div>
						...
						if (isset($_POST['update_emergency'])) {
								...
								$surgery_performed_var = mysqli_real_escape_string($db, $_POST['surgery_performed']);
								$intraop_var = mysqli_real_escape_string($db, $_POST['intraop']);
								$date_surgery_var = mysqli_real_escape_string($db, $_POST['date_surgery']);
								$time_of_surgery_var = mysqli_real_escape_string($db, $_POST['time_of_surgery']);
								$reason_for_delay_var = mysqli_real_escape_string($db, $_POST['reason_for_delay']);
								$admissionsummary_1_var = mysqli_real_escape_string($db, $_POST['admissionsummary1']);
								$admissionsummary_2_var = mysqli_real_escape_string($db, $_POST['admissionsummary2']);
								$admissionsummary_3_var = mysqli_real_escape_string($db, $_POST['admissionsummary3']);
							...
							$query2 = "UPDATE emergency_surgery_records_tb SET  date_of_presentation = '$datepre_var', firstname = '$firstname_var' , lastname = '$lastname_var', hosp_number = '$hospitalnumber_var', age = '$age_var' , gender = '$gender_var', pc = '$pc_var', hx ='$hx_var' , hpc ='$hpc_var' , phy = '$phy_var', available_ix ='$available_var' , diagnosis ='$diagnosis_var', diagnosis_two =  '$diagnosis_two_var' , requested_ix = '$requested_ix_var', plan = '$plan_var' , er_care_summary = '$er_care_summary_var', surgery_performed = '$date_time_surgery_var', intraop = '$intraop_var', date_surgery = '$date_surgery_var' , time_of_surgery = '$time_of_surgery_var', reason_for_delay = '$reason_for_delay_var', admission_summary_1 = '$admissionsummary_1_var', admission_summary_2 = '$admissionsummary_2_var' , admission_summary_3 = '$admissionsummary_3_var' , complications = '$complication_var' , outcome = '$outcomes_var', date_of_discharge = '$dateofdischarge_var', length_hospital_stay = '$length_hospital_stay_var', surgeon = '$surgeon_var', date_of_surgery = '$dateofsurgery2_var' , total_cost_of_care = '$totalcostofcare_var' , cost_of_surgery = '$costofsurgery_var' , education = '$education_var', fatheroccup = '$fathermonthlyoccupation_var', motheroccup = '$mothermonthlyoccupation_var', father_monthly_income = '$fathermonthlyincome_var' , mother_monthly_income = '$mothermonthlyincome_var', monthly_household_expenditure= '$monthlyexpenditure_var' , monthly_income_left = '$monthlyincomeleft_var', source_of_fund = '$sourcecurrenthealthexpenditure_var' WHERE hosp_number = '$hospitalnumber_var' " ;
							$query_run2 =mysqli_query($db, $query2);



							if($query_run2) {
								echo '<script type="text/javascript"> alert("Emergency Record Updated")</script>';
							}else
								{
									echo '<script type="text/javascript"> alert("Emergency Record Not Updated")</script>';
								}
