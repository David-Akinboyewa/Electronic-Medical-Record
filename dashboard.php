						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li><a href="patient-records.php">Update Patient Record</a></li>
								</ul>
							</li>
							<li class="submenu">
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								...
								<h4 class="page-title" style="color:#ff0099; font-size: 20px;">Total N<u>o</u> of Patients:
								...
								<b><a href="download.php">Click Here to Download</a></b>
							...
							<div class="card dash-widget">
								<div class="card-body">
									...
									<h3>
										...
										<span style="color:#ff0099; font-size: 19px";> Elective Surgery</span>
									</div> 
								</div>
							</div>
						</div>
							...
							<div class="card dash-widget">
								<div class="card-body">
									...
									<div class="dash-widget-info">
										...
										<span style="color:#ff0099; font-size: 19px">Emergency Surgery </span>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card dash-widget">
								<div class="card-body">
									...
									<div class="dash-widget-info">
										...
										<span style="color:#ff0099; font-size: 19px" >Ward Consult </span>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card dash-widget">
								<div class="card-body">
									...
									<div class="dash-widget-info">
										...
										<span style="color:#ff0099; font-size: 19px" >Clinical Record</span>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card dash-widget">
								<div class="card-body">
									...
									<div class="dash-widget-info">
										...
										<span style="color:#ff0099; font-size: 19px" >Unoperated Consult Including Dama & Death 1 </span>
									</div>
								</div>
							</div>
						</div>
