...
//	}
	...
	if(isset($_POST['search-button'])){
			...
			$id_elective_var = mysqli_real_escape_string($db, $_POST['id_elective']);
			$hospitalnumber_elective_var = mysqli_real_escape_string($db, $_POST['hospitalnumber']);
			$diagnosis_elective_var = mysqli_real_escape_string($db, $_POST['diagnosis']);
			$query_elective =("DELETE FROM elective_surgery_records_tb WHERE hosp_number = '$hospitalnumber_elective_var' AND id = '$id_elective_var' ")  or die("could not search");
			$result_elective = mysqli_query($db, $query_elective);
...
<head>
        ...
        <title>Delete Elective Record</title>
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">Elective Record</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item active" style="color:orange; font-size:20px ;">Delete <?php echo$hospitalnumber_var?> :: <?php echo$firstname_var ?> <?php echo$lastname_var ?> from Elective Record</li><li class="breadcrumb-item active"><li ><mark><a href="patient-records.php" style="border-line:5px; color: green; border: 1px;" >Back</a></mark></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="row filter-row">
							<div class="col-sm-6 col-md-3">  
								<div class="form-group form-focus">
									<input type="text" class="form-control floating" placeholder="" name="id_elective" value="<?php echo$id_var ?>">
