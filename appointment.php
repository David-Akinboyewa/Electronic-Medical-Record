									...
									<form action="#">
										<div class="input-group">
											...
											<div class="input-group-append">
												<button class="btn btn-primary" type="button" name="appoint-search">Search</button>
											</div>
										</div>
									</form>
								</div>
								...
								<div class="card-body">
									...
									<div class="table-responsive">
										<table class="datatable table table-stripped mb-0">
											...
											$res=mysqli_query($db, "select * from appointment_tb");
											while ($row = mysqli_fetch_array($res)) {

												echo "<tr>";
												echo "<td>"; echo $row["snumber"]; echo"</td>";
												...
												echo "<td>"; echo $row["apptime"]; echo"</td>";
