...
<head>
        ...
        <title>Update Unoperated Consult</title>
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">Update Unoperated Consult</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item active">Update Unoperated Consult</li><li class="breadcrumb-item active"><a href="unoperated_consult.php"  style="color:red;">Back</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<!-- Search Filter -->
					<form action="update_unoperated.php" method="post">
                ...
                <!--</form>-->
					<!-- /Search Filter -->
						...
						<?php
								...
								$query = "SELECT * FROM unoperated_consult_records_tb WHERE hosp_number = '$hospitalnumber_var' ";
							...
							<div class="card">
								...
								<div class="card-body">
									<form action="update_unoperated.php" method="post">
										...
										<div class="form-group">
											<label>2<sup>nd</sup>HPC Summary</label>
												<textarea type="text" class="form-control" placeholder="" name="hpc" value="<?php echo $row['hpc']?>"> <?php echo $row['hpc']?> </textarea>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label>Availabel investigation</label>
										...
										<div class="form-group">
											...
											<textarea type="text" class="form-control" placeholder="" name="requested" value=""><?php echo $row['requested']?>"</textarea>
										</div>
										<div class="form-group">
											<label>Plan</label>
										...
										<div class="text-center">
											<button type="submit" class="btn btn-primary" name="update_unoperated">Update</button>
										</div>										
									</form>
								</div>
							</div>
						...
						if (isset($_POST['update_unoperated'])) {
								$datepre_var = mysqli_real_escape_string($db, $_POST['datepre']);
								$firstname_var = mysqli_real_escape_string($db, $_POST['firstname']);
								$lastname_var = mysqli_real_escape_string($db, $_POST['lastname']);
								$hospitalnumber_var = mysqli_real_escape_string($db, $_POST['hospitalnumber']); 
