<?php include("server.php"); 
		...
		$query1 = ("SELECT * FROM   clinical_records_tb WHERE hosp_number = $hospitalnumber_var" ) or die("could not search");
		...
		$queryResult = mysqli_num_rows($result1);
			...
			$plan_var =  $row['plan'];
			$secondvisit_var = $row['secondvisit'];
			$thirdvisit_var =  $row['thirdvisit'];
		}
...
<head>
        ...
        <title>Update clinical surgery</title>
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								...
								<ul class="breadcrumb">
									<li class="breadcrumb-item active">Update Clinical Record</li><li class="breadcrumb-item active"><a href="patient-records.php"  style="color:red;">Back</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<!-- /Search Filter -->
								...
								<div class="card-body">
									<form action="update_clinical.php" method="post">
										<div class="form-group">
											...
											<input type="number" class="form-control" placeholder="" name="hosp_number" value="<?php echo $hospitalnumber_var ?>"/>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" placeholder="" name="firstname" value="<?php  echo $firstname_var; ?>"/>
										</div>
										<div class="form-group">
											<label>Last Name</label>
											<input type="text" class="form-control" placeholder="" name="lastname" value="<?php echo $lastname_var ?>"/>
										</div>
										<div class="form-group">
											<label>Hospital Number</label>
											<input type="text" class="form-control" placeholder="" name="hospitalnumber" value="<?php echo $hospitalnumber_var?>"/>
										</div>
										<div class="form-group">
											<label>Address</label>
											<textarea type="text" class="form-control" placeholder="" name="address" value=""/> <?php echo $address_var ?></textarea>
										</div>
										<div class="form-group">
											<label>Phone</label>
											<input type="text" class="form-control" placeholder="" name="phonenumber" value="<?php echo $hospitalnumber_var; ?>"/>
										</div>
										<div class="form-group">
											<label>Age</label>
											<input type="text" class="form-control" placeholder="" name="age" value="<?php echo $age_var?>"/>
										</div>
										
										<div class="form-group">
											<label>Gender</label>	
											<input type="text" class="form-control" placeholder="" name="gender" value="<?php echo $gender_var ?>"/>
										</div>
										<div class="form-group">
											<label>Source of Referral</label>
											<textarea type="text" class="form-control" placeholder="" name="sourceofreferral" value="<?php $sourceofreferral_var ?>" ><?php $sourceofreferral_var ?></textarea>
										</div>
										<div class="form-group">
											<label>Presenting Compliant</label>
											<textarea type="text" class="form-control" placeholder="" name="presentingcompliant" value="<?php echo $row['presenting_compliant'] ?>"> <?php echo $presentingcompliant_var?> </textarea>
										</div>
										<div class="form-group">
											<label>HPC Summary</label>
											<textarea type="text" class="form-control" placeholder="" name="hpc" value="<?php echo $hpc_var?>" ></textarea>
										</div>
										<div class="form-group">
											<label>Examination</label>
											<textarea type="text" class="form-control" placeholder="" name="examination" value="<?php echo $examination_var?>" > <?php echo $examination_var?></textarea>
										</div>
										<div class="form-group">
											<label>Diagnosis</label>
											<input type="text" class="form-control" placeholder="" name="diagnosis" value="<?php echo $diagnosis_var?>">
										</div>
										<div class="form-group">
											<label>Diagnosis (Others)</label>
											<input type="text" class="form-control" placeholder="" name="diagnosis_two" value="<?php echo $diagnosis_two_var?>">
										</div>
										<div class="form-group">
											<label>Available Investigations</label>
											<textarea type="text" class="form-control" placeholder="" name="availableinvestigations" value="<?php echo $row['available_investigations'] ?>"> <?php echo $availableinvestigations_var ?> </textarea>
										</div>
										<div class="form-group">
											<label>Requested </label>
											<input type="text" class="form-control" placeholder="" name="requested" value="<?php echo $requested_var ?>">
										</div>
										<div class="form-group">
											<label>Plan</label>
												<textarea type="textarea" class="form-control" placeholder="" name="plan" value="<?php echo $plan_var?>"> <?php echo $plan_var?></textarea>
										</div>
										<div class="form-group">
											<label>2nd Visit</label>
												<textarea type="textarea" class="form-control" placeholder="" name="secondvisit" value="<?php echo $secondvisit_var ?>"> <?php echo $secondvisit_var ?></textarea>
										</div>
										<div class="form-group">
											<label>3rd Visit</label>
												<textarea type="textarea" class="form-control" placeholder="" name="thirdvisit" value="<?php echo $thirdvisit_var?>"> <?php echo $thirdvisit_var?></textarea>
										</div>
										<div class="form-group">
						...
						if (isset($_POST['update_clinical'])) {
							...
							$query2 = "UPDATE  clinical_records_tb SET  date_of_presentation = '$datepre_var', firstname = '$firstname_var' , lastname = '$lastname_var', hosp_number = '$hospitalnumber_var',  address = '$address_var', phonenumber = '$phonenumber_var', age = '$age_var' , gender = '$gender_var', source_of_referral = '$sourceofreferral_var', presenting_compliant = '$presentingcompliant_var', hpc ='$hpc_var' , examination = '$examination_var', diagnosis ='$diagnosis_var', diagnosis_two =  '$diagnosis_two_var' , available_investigations = '$availableinvestigations_var', requested = '$requested_var', plan = '$plan_var' , secondvisit = '$secondvisit_var', thirdvisit = '$thirdvisit_var' WHERE hosp_number = '$hospitalnumber_var' " ;
								...
								header("location: index.php?hosp_number=$hospitalnumber_var");
							if($query_run2) {
