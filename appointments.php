...
<!-- Mirrored from dreamguys.co.in/smarthr/orange/users.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 12 Apr 2020 11:59:41 GMT -->
<head>
        <meta charset="utf-8">
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">Appointment Booking</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="index.html">Appointment Booking</a></li>
						...
						<div class="row filter-row">
							<div class="col-sm-6 col-md-3">  
								<div class="form-group form-focus">
									...
									<label class="focus-label">Dr Name or Patient Name</label>
								</div>
							</div>
							<!--<div class="col-sm-6 col-md-3">  
								<div class="form-group form-focus">
								...
								<table class="table table-striped custom-table datatable">
									...
									<tbody>
										<!--<tr>
											...
											$query = ("SELECT * FROM   appointment_tb WHERE pname LIKE '%$name_var%' OR doctor LIKE '%$name_var%' ORDER BY curent_date DESC " ) or die("could not search");
											$result = mysqli_query($db, $query);
											$queryResult = mysqli_num_rows($result);
											echo"<b style = 'color:red'; >" .$queryResult; echo"</b>"; echo" results found for"; echo" <b style = 'color:orange'; >" .$name_var; echo"</b>"; 
														
														$counter_var2 = 1;
													if ($queryResult > 0 ) {
														while($row = mysqli_fetch_assoc($result)){
															$idrow= $row["snumber"];
															$rowlink = 'appointment_details.php?snumber='.$idrow;
															echo "<tr> ";
															echo "<td>";  echo $counter_var2; ; echo "</td>";
															echo "<td>"; echo $row["pname"]; echo"</style>"; echo"</td>";
															echo "<td>"; echo $row["pnumber"];  echo"</td>";
															echo "<td>"; echo $row["symptoms"]; echo"</td>";
															echo "<td>"; echo $row["gender"];   echo"</td>";
															echo "<td>"; echo $row["age"]; 		echo"</td>";
															echo "<td>"; echo $row["appdate"]; echo"</td>";
															echo "<td style=''>"; echo $row["curent_date"]; echo"</td>";
															echo "<td>"; echo $row["doctor"];  echo"</td>";
															echo "<td>"; echo "<a href='".$rowlink."'><input type='button' name = 'view' value='View' style=' border-style:dashed; color:orange; border-width:1px;'></a>"; echo"</td>";
															echo "</tr>";
															$counter_var2++;
														}
													}
