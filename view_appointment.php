        ...
        <div class="main-wrapper">
            ...
            <div class="header">
                ...
                <div class="header-left">
                    <a href="view_appointment.php" class="logo">
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">View Appointment Booking</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="index.html">View Appointment Booking</a></li>
								...
								<table class="table table-striped custom-table datatable">
									...
									<tbody>
										<!--<tr>
											...
											<?php
											$counter_var = 1;
											$res=mysqli_query($db, "SELECT * FROM  appointment_tb  ORDER BY appdate ASC LIMIT 1 ");
											while ($row = mysqli_fetch_array($res)) {

												echo "<tr>";
												
												echo "<td>"; echo $row["pname"]; echo"</td>";echo "</br>";
