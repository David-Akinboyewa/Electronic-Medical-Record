<?php include('server.php');
		...
		$query2 = ("SELECT * FROM   clinical_records_tb WHERE hosp_number = $hospitalnumber_var" ) or die("could not search");
        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<!-- Search Filter -->
					<form action="delete_clinical_record.php" method="post">
						<div class="row filter-row">
							<div class="col-sm-6 col-md-3">  
								<div class="form-group form-focus">
									<input type="text" class="form-control floating" name="name" value="<?php echo $hospitalnumber_var?>"
							...
							<div class="col-sm-6 col-md-3"> 
								<div class="form-group form-focus select-focus">
									<select class="select floating" name="clinical_records_tb" >
										<!--<option ></option>-->
							...
							<div class="col-sm-6 col-md-3">
								<button class="btn btn-success btn-block" type="submit" name="click_btn"> Search</button>  
										...
										<!--<tr>
											...
											echo"<b style = 'color:red'; >" .$queryResult; echo"</b>"; echo" results found for"; echo" <b style = 'color:orange'; >" .$name_var; echo"</b>"; echo" or "; echo"<b style = 'color: orange';>" .$diagnosis_var; echo"</b>"; echo" from "; echo "<b style = 'color:orange';> " .$records_var; echo "</b>";
														...
														while($row2= mysqli_fetch_assoc($result)){
															...
															//$rowlink_patient_records = 'patient-records.php?hosp_number='.$idrow_clinical;
															...
															echo "<td>"; echo "<a href='".$rowlink_clinical_delete." target='_blank';'><input type='submit' name = 'delete_clinical' value='Delete' style=' border-style:dashed; color:red; border-width:1px; '></a>"; echo"</td>";
															echo "</tr>";														
