<?php include("server.php"); 
			...
			$sql_status = "SELECT hosp_number FROM elective_surgery_records_tb WHERE hosp_number = '$hospitalnumber_var' ";
			...
			//ensure that hospital number is entered into the form fields.
				...
				$insert_elective = "INSERT INTO elective_surgery_records_tb ( date_of_presentation, firstname, lastname, hosp_number, age, gender, pc, hpc, phy_exam , inv, diagnosis, diagnosis_two, pre_op_mgt_summary, surgery_performed, date_of_surgery, reason_for_delay, intra_op, post_op_summary1, post_op_summary2,post_op_summary3, complication, outcomes , date_of_discharge, surgeon , date_of_surgery2, date_of_discharge2, length_hospital_stay, cost_of_surgery , total_cost_of_care , education, father_occupation, mother_occupation, father_monthly_income, mother_monthly_income, monthly_expenditure, monthly_income_left, source_current_health_expenditure ) VALUES ('$datepre_var','$firstname_var', '$lastname_var','$hospitalnumber_var', '$age_var', '$gender_var', '$pc_var', '$hpc_var','$phy_var' , '$inv_var' , '$diagnosis_var','$diagnosis_two_var' ,'$preop_var','$surgeryperformed_var','$dateofsurgery_var', '$reasonfordelay_var' , '$intraop_var', '$postopsummary1_var', '$postopsummary2_var', '$postopsummary3_var', '$complication_var', '$outcomes_var' , '$dateofdischarge_var', '$surgeon_var' , '$dateofsurgery2_var', '$dateofdischarge2_var', '$lengthHospitalstay_var', '$costofsurgery_var' , '$totalcostofcare_var' , '$education_var', '$fatheroccupation_var', '$motheroccupation_var', '$fathermonthlyincome_var', '$mothermonthlyincome_var', '$monthlyexpenditure_var', '$monthlyincomeleft_var', '$sourcecurrenthealthexpenditure_var')";
				$query_run = mysqli_query($db, $insert_elective);

				if($query_run) {
					echo '<script type="text/javascript"> alert("Elective Information Saved ")</script>';
				}else
					{
						echo '<script type="text/javascript"> alert("Elective Infromation Not Saved")</script>';
					}
				}
        ...
        <div class="main-wrapper">
            ...
            <div class="header">
                ...
                <div class="header-left">
                    <a href="elective_surgery.php" class="logo">
						...
						<ul>
							...
							<li class="active">
								...
								<ul style="display: none;">
									...
									<a href="update_elective.php">Update Elective Surgery</a></li>
								</ul>
							</li>
							<li class="submenu">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								...
								<ul class="breadcrumb">
									<li class="breadcrumb-item active">Elective Surgery Record</li><li class="breadcrumb-item active"><a href="update_elective.php"  style="color:red;">Update Elective Surgery</a></li><li class="breadcrumb-item active"><a href="add_patient_record.php"  style="color:red;">Back</a></li>
								</ul>
							</div>
						</div>
					</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<form action="elective_surgery.php" method="post">
										...
										<div class="form-group">
											<label>PC</label>
											<input type="text" class="form-control" placeholder="" name="pc">
										</div>
										<div class="form-group">
											<label>HPC Summary</label>
											<input type="text" class="form-control" placeholder="" name="hpc">
										</div>
										<div class="form-group">
											<label>PHY.Exam</label>
											<input type="text" class="form-control" placeholder="" name="phy_exam">
										</div>
										<div class="form-group">
											<label>INV</label>
											<input type="text" class="form-control" placeholder="" name="inv">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" placeholder="" name="pre-op">
										</div>
										<div class="form-group">
											<label>Surgery Performed</label>
											<input type="text" class="form-control" placeholder="" name="surgeryperformed">
										</div>
										<div class="form-group">
											<label>Date of Surgery</label>
											<input type="date" class="form-control" name="dateofsurgery">
										</div>
										<div class="form-group">
											<label>Reason for delay.If any. WHO 3 delay framework</label>
												<input type="text" class="form-control" placeholder="" name="reasonfordelay">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label>Post Op summary 1</label>
												<textarea type="text" class="form-control" placeholder="" name="postopsummary1"> </textarea>
										</div>
										<div class="form-group">
											<label>Post Op summary 2</label>
												<textarea type="text" class="form-control" placeholder="" name="postopsummary2"> </textarea>
										</div>
										<div class="form-group">
											<label>Post Op summary 3</label>
												<textarea type="text" class="form-control" placeholder="" name="postopsummary3"> </textarea>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label>Date of Surgery</label>
											<input type="date" class="form-control" name="dateofsurgery2">
										</div>
										<div class="form-group">
											<label>Date of Discharge 2</label>
											<input type="date" class="form-control" placeholder="placeholder" name="dateofdischarge2">
										</div>
										<div class="form-group">
											<label>Lenght of Hospital Stay</label>
											<input type="number" class="form-control" placeholder="" name="lengthhospitalstay">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label>Total Cost of Care (NGN)</label>
											  <select class="form-control" placeholder="" name="totalcostofcare">
											  	<option > </option>
											  <option value="Not - Specified">Not - Specified</option>
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" placeholder="" name="fathermonoccup">
										</div>
										<div class="form-group">
											<label>Mother's Occupation</label>
											<input type="text" class="form-control" placeholder="" name="mothermonoccup">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="number" class="form-control" name="monthlyincomeleft">
										</div>
										<div class="form-group">
										...
										<div class="text-center">
											<button type="submit" class="btn btn-primary" name="elective">Submit</button>
										</div>										
									</form>
								</div>
							</div>
