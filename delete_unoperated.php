<?php include('server.php');
		...
		$query = ("SELECT * FROM  unoperated_consult_records_tb WHERE hosp_number = $hospitalnumber_var" ) or die("could not search");
		$result = mysqli_query($db, $query);
		//$queryResult = mysqli_num_rows($result);
			while($row = mysqli_fetch_assoc($result)){ 
			$id_var = $row['id_unoperated_consult'];
...
//	}
	...
	if(isset($_POST['search-button'])){
			...
			$id_unoperated_var = mysqli_real_escape_string($db, $_POST['id_unoperated']);
			$hospitalnumber_unoperated_var = mysqli_real_escape_string($db, $_POST['hospitalnumber']);
			$diagnosis_unoperated_var = mysqli_real_escape_string($db, $_POST['diagnosis']);
			$query_unoperated =("DELETE FROM   unoperated_consult_records_tb WHERE hosp_number = '$hospitalnumber_unoperated_var' AND 	id_unoperated_consult  = '$id_unoperated_var' ")  or die("could not search");
			$result_unoperated = mysqli_query($db, $query_unoperated);
			//$queryResult = mysqli_num_rows($result_clinical);
		if($result_unoperated) {
				echo '<script type="text/javascript"> alert("Deleted")</script>';
...
<head>
        ...
        <title>Delete  Unoperated Record</title>
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								...
								<ul class="breadcrumb">
									<li class="breadcrumb-item active" style="color:orange; font-size:20px ;">Delete <?php echo$hospitalnumber_var?> :: <?php echo$firstname_var ?> <?php echo$lastname_var ?> from Unoperated Record</li><li class="breadcrumb-item active"><li ><mark><a href="patient-records.php" style="border-line:5px; color: green; border: 1px;" >Back</a></mark></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="row filter-row">
							<div class="col-sm-6 col-md-3">  
								<div class="form-group form-focus">
									<input type="text" class="form-control floating" name="id_unoperated" value="<?php echo$id_var ?>">
