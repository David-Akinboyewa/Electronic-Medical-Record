...
*/
		...
		if (isset($_POST['activate'])) {
			...
			//Email to Admin
				...
				$message ="<a href = 'https://ehealthpsuluth.com/admin_login.php' > $firstname_var, View User</a>";
				//$headers = "From: akinboyewadavid@gmail.com \r\n";
				...
				<ul class="nav user-menu">
					...
					<li class="nav-item dropdown has-arrow main-drop">
						...
						<div class="dropdown-menu">
							...
							<a class="dropdown-item" href="admin_access.php">Admin Panel</a>
