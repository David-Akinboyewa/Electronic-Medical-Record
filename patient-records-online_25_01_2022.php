										...
										<!--<tr>
											...
											echo"<b style = 'color:red'; >" .$queryResult; echo"</b>"; echo" results found for"; echo" <b style = 'color:orange'; >" .$name_var; echo"</b>"; echo" or "; echo"<b style = 'color: orange';>" .$diagnosis_var; echo"</b>"; echo" from "; echo "<b style = 'color:orange';> " .$records_var; echo "</b>";
														...
														while($row = mysqli_fetch_assoc($result)){
															...
															echo "<td>"; echo "<a href='".$rowlink_clinical."'><input type='submit' name = 'view' value='View' style=' border-style:dashed; color:orange; border-width:1px;'></a>"; echo"</td>";
															echo "</tr>";														
														...
														elseif ($records_var == "elective_surgery_records_tb") {
															...
															echo "<td>"; echo $row["diagnosis_two"]; echo"</td>";
															echo "<td>"; echo $row["gender"]; echo"</td>";
															echo "<td>"; echo "<a href='".$rowlink_elective."'><input type='submit' name = 'view' value='View' style=' border-style:dashed; color:orange; border-width:1px;'></a>"; echo"</td>";
															echo "</tr>";														
													...
													elseif ($records_var == "emergency_surgery_records_tb") {
															...
															echo "<td>"; echo $row["diagnosis_two"]; echo"</td>";
															echo "<td>"; echo $row["gender"]; echo"</td>";
															echo "<td>"; echo "<a href='".$rowlink_emergency."'><input type='submit' name = 'view' value='View' style=' border-style:dashed; color:orange; border-width:1px;'></a>"; echo"</td>";
															echo "</tr>";														
													...
													elseif ($records_var == "unoperated_consult_records_tb") {
															...
															$idname_unoperated = $row["firstname"];
															...
															echo "<td>"; echo $row["diagnosis_two"]; echo"</td>";
															echo "<td>"; echo $row["gender"]; echo"</td>";
															echo "<td>"; echo "<a href='".$rowlink_unoperated."'><input type='submit' name = 'view' value='View' style=' border-style:dashed; color:orange; border-width:1px;'></a>"; echo"</td>";
															echo "</tr>";														
													...
													elseif ($records_var == "ward_consult_records_tb") {
															$idrow_ward = $row["hosp_number"];
															$rowlink_ward = 'view_ward_consult.php?hosp_number='.$idrow_ward;
															echo "<tr>";
															echo "<td>"; echo $counter_var; echo"</td>";
															echo "<td>"; echo $row["firstname"]; echo"</td>";
															echo "<td>"; echo $row["lastname"]; echo"</td>";
															...
															echo "<td>"; echo $row["diagnosis_two"]; echo"</td>";
															echo "<td>"; echo $row["gender"]; echo"</td>";
															echo "<td>"; echo "<a href='".$rowlink_ward."'><input type='submit' name = 'view' value='View' style=' border-style:dashed; color:orange; border-width:1px;'></a>"; echo"</td>";
															echo "</tr>";														
