<?php include('server.php');
		...
		$query = ("SELECT * FROM   clinical_records_tb WHERE hosp_number = $hospitalnumber_var" ) or die("could not search");
...
//	}
	...
	if(isset($_POST['search-button'])){
			...
			$id_clinical_var = mysqli_real_escape_string($db, $_POST['id_clinical']);
			$hospitalnumber_clinical_var = mysqli_real_escape_string($db, $_POST['hospitalnumber']);
			$diagnosis_clinical_var = mysqli_real_escape_string($db, $_POST['diagnosis']);
			$query_clinical =("DELETE FROM  clinical_records_tb WHERE hosp_number = '$hospitalnumber_clinical_var' AND id = '$id_clinical_var' ")  or die("could not search");
...
<head>
        ...
        <title>Delete Clinical Record</title>
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								...
								<ul class="breadcrumb">
									<li class="breadcrumb-item active" style="color:orange; font-size:20px ;">Delete <?php echo$hospitalnumber_var?> :: <?php echo$firstname_var ?> <?php echo$lastname_var ?> from Clinical Record</li><li class="breadcrumb-item active"><li ><mark><a href="patient-records.php" style="border-line:5px; color: green; border: 1px;" >Back</a></mark></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="row filter-row">
							<div class="col-sm-6 col-md-3">  
								<div class="form-group form-focus">
									<input type="text" class="form-control floating" placeholder="" name="id_clinical" value="<?php echo$id_var ?>">
