...
<!-- Mirrored from dreamguys.co.in/smarthr/orange/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 12 Apr 2020 11:58:44 GMT -->
<head>
        <meta charset="utf-8">
							...
							<div class="card-group m-b-30">
								<div class="card">
									<div class="card-body">
										...
										<h3 class="mb-3">
											<?php
										$query = ("SELECT * FROM   elective_surgery_records_tb" ) or die("could not search");
										...
										<div class="progress mb-2" style="height: 5px;">
											<div class="progress-bar bg-primary" role="progressbar" style="width:98px;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" ></div>
										</div>
						...
						<div class="col-md-12 col-lg-6 col-xl-4 d-flex">
							<div class="card flex-fill">
								<div class="card-body">
									...
									$query = ("SELECT * FROM   elective_surgery_records_tb" ) or die("could not search");
										$result = mysqli_query($db, $query);
										$queryResult1 = mysqli_num_rows($result);
										//echo $queryResult;

										
										$query = ("SELECT * FROM   emergency_surgery_records_tb" ) or die("could not search");
										$result = mysqli_query($db, $query);
										$queryResult2 = mysqli_num_rows($result);
										//echo $queryResult;

										$query = ("SELECT * FROM ward_consult_records_tb" ) or die("could not search");
										$result = mysqli_query($db, $query);
										$queryResult3 = mysqli_num_rows($result);
										//echo $queryResult;
										 

										$query = ("SELECT * FROM clinical_records_tb" ) or die("could not search");
										$result = mysqli_query($db, $query);
										$queryResult4 = mysqli_num_rows($result);
										//echo $queryResult;

										$query = ("SELECT * FROM  unoperated_consult_records_tb" ) or die("could not search");
										$result = mysqli_query($db, $query);
										$queryResult5 = mysqli_num_rows($result);
										echo $queryResult1 + $queryResult2 + $queryResult3 + $queryResult4 + $queryResult5;
								 ...
								 ?>
									...
									<div>
										<p><i class="fa fa-dot-circle-o text-purple mr-2"></i>Elective Surgery <span class="float-right"> <?php
										$query = ("SELECT * FROM   elective_surgery_records_tb" ) or die("could not search");
										$result = mysqli_query($db, $query);
										$queryResult = mysqli_num_rows($result);
											echo $queryResult;
										 ?></span></p>
										<p><i class="fa fa-dot-circle-o text-warning mr-2"></i>Emergency Surgery <span class="float-right"><?php
										$query = ("SELECT * FROM   emergency_surgery_records_tb" ) or die("could not search");
										$result = mysqli_query($db, $query);
										$queryResult = mysqli_num_rows($result);
											echo $queryResult;
										 ?></span></p>
										<p><i class="fa fa-dot-circle-o text-success mr-2"></i>Ward Consult <span class="float-right"><?php
										$query = ("SELECT * FROM ward_consult_records_tb" ) or die("could not search");
										$result = mysqli_query($db, $query);
										$queryResult = mysqli_num_rows($result);
											echo $queryResult;
										 ?></span></p>
										<p><i class="fa fa-dot-circle-o text-danger mr-2"></i>Clinical Record<span class="float-right"><?php
										$query = ("SELECT * FROM clinical_records_tb" ) or die("could not search");
										$result = mysqli_query($db, $query);
										$queryResult = mysqli_num_rows($result);
											echo $queryResult;
										 ?></span></p>
										<p class="mb-0"><i class="fa fa-dot-circle-o text-info mr-2"></i>Unoperated Consult Including Dama & Death 1 <span class="float-right"><?php
										$query = ("SELECT * FROM  unoperated_consult_records_tb" ) or die("could not search");
										$result = mysqli_query($db, $query);
										$queryResult = mysqli_num_rows($result);
											echo $queryResult;
