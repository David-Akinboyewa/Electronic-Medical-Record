<?php include('server.php');
		...
		if(isset($_POST['change-password'])){
			...
			$oldpassword_var = mysqli_real_escape_string($db, $_POST['oldpassword']);
			$newpassword_var = mysqli_real_escape_string($db, $_POST['password-change']);
			$newpassword2_var = mysqli_real_escape_string($db, $_POST['confirm-password']);


					if (empty($oldpassword_var)) {
						array_push($errors, "Old password is required");
					}
					if (empty($newpassword_var)) {
						array_push($errors, "New password is required");
					}
					if (empty($newpassword2_var)) {
						array_push($errors, "Enter confirm password");
					}
					if ($newpassword_var != $newpassword2_var) {
						array_push($errors, " New Password does not match");
					}

					if (count($errors) == 0) {

							$query = "UPDATE ehealth_reg SET password = '$newpassword_var' WHERE email = '$email_var' ";
        ...
        <div class="main-wrapper">
            ...
            <div class="header">
                ...
                <div class="header-left">
                    <a href="change-password.php" class="logo">
						...
						<div class="col-md-6 offset-md-3">
							...
							<div class="page-header">
								<div class="row">
									<div class="col">
										...
										<ul class="breadcrumb">
											<li class="breadcrumb-item active"><a href="dashboard.php"  style="color:red;">Back</a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<form action="change-password.php" method="post">
								...
								<div class="form-group">
									...
									<input type="password" class="form-control" name="password-change">
								</div>
								<div class="form-group">
								...
								<div class="submit-section">
									<button class="btn btn-primary submit-btn" type="submit" name="change-password">Change Password</button>
								</div>
							</form>
						</div>
					</div>
...
<!-- Mirrored from dreamguys.co.in/smarthr/orange/change-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 12 Apr 2020 11:59:46 GMT -->
</html>