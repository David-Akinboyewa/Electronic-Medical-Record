...
<head>
        ...
        <title>view unoperated consult</title>
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">Unoperated Consult</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item active">Unoperated Consult</li><li class="breadcrumb-item active"><a href="patient-records.php"  style="color:red;">Back</a></li>
								</ul>
							</div>
						</div>
					</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<form action="update_clinical.php" method="post">
										...
										<div class="form-group">
											<label>(18.) 2nd Review:- </label>&nbsp;&nbsp; <?php echo $secondreview_var ?> 
										</div>
										<div class="form-group">
											<label>(19.) 3rd Review:- </label>&nbsp;&nbsp; <?php echo $thirdreview_var?>
										</div>
