...
<head>
        ...
        <title>view clinical record</title>
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								...
								<ul class="breadcrumb">
									<li class="breadcrumb-item active">Clinical Record</li><li class="breadcrumb-item active"><a href="patient-records.php"  style="color:red;">Back</a></li>
								</ul>
							</div>
						</div>
					</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<form action="update_clinical.php" method="post">
										...
										<div class="form-group"> 
											<label>(9.) Source of Referral :- </label>&nbsp;&nbsp; <?php echo $sourceofreferral_var ?>
										</div>
										<div class="form-group">
											<label>(10.) Presenting Compliant :- </label>&nbsp;&nbsp;<?php echo $presentingcompliant_var?>
										</div>
										<div class="form-group">
											<label>(11.) HPC Summary :- </label>&nbsp;&nbsp; <?php echo $hpc_var?>
										</div>
										<div class="form-group">
											<label>(12.) Examination :- </label>&nbsp;&nbsp; <?php echo $examination_var?>
										</div>
										<div class="form-group">
											<label>(13.) Diagnosis :- </label>&nbsp;&nbsp; <?php echo $diagnosis_var?>
										</div>
										<div class="form-group">
											<label>(14.) Diagnosis (Others) :- </label>&nbsp;&nbsp; <?php echo $diagnosis_two_var?>
										</div>
										<div class="form-group">
											<label>(15.) Available Investigations :- </label>&nbsp;&nbsp; <?php echo $availableinvestigations_var ?>
										</div>
										<div class="form-group">
											<label>(16.) Requested :- </label>&nbsp;&nbsp; <?php echo $requested_var ?>
										</div>
										<div class="form-group">
											<label>(17.) Plan :- </label>&nbsp;&nbsp; <?php echo $plan_var?>
										</div>
										<div class="form-group">
											<label>(18.) 2nd Visit :- </label>&nbsp;&nbsp; <?php echo $secondvisit_var ?> 
										</div>
										<div class="form-group">
											<label>(19.) 3rd Visit :- </label>&nbsp;&nbsp; <?php echo $thirdvisit_var?>
										</div>
