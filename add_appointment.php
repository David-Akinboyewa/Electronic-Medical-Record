...
*/
	if (isset($_POST['appointment'])) {
			$pname_var = mysqli_real_escape_string($db, $_POST['pname']);
			$phoneNo_var = mysqli_real_escape_string($db, $_POST['pnumber']);
			$email_var = mysqli_real_escape_string($db, $_POST['appemail']);
			$symptoms_var = mysqli_real_escape_string($db, $_POST['symptoms']);
			$gender_var = mysqli_real_escape_string($db, $_POST['gender']);
			$age_var = mysqli_real_escape_string($db, $_POST['age']);
			$date_var = mysqli_real_escape_string($db, $_POST['appdate']);
			$time_var = mysqli_real_escape_string($db, $_POST['apptime']);
			$doctor_var = mysqli_real_escape_string($db, $_POST['doctor']);
			...
			if (empty($symptoms_var)) {
				array_push($errors, "Symptoms is required");
			}
			if (empty($gender_var)) {
			...
			if (count($errors)== 0) {
				$appoint = " INSERT INTO appointment_tb (pname, pnumber, appemail, symptoms, gender, age, appdate, apptime, doctor ) VALUES ('$pname_var', '$phoneNo_var', '$email_var', '$symptoms_var', '$gender_var', '$age_var', '$date_var','$time_var', '$doctor_var') ";
				mysqli_query($db, $appoint);				
									...
									<form action="add_appointment.php" method="post">
										...
										<div class="row">
											<div class="col-md-6">
												...
												<div class="form-group">
													<label>Email</label>
													<input type="email" class="form-control" name="appemail">
												</div>
												<div class="form-group">
										...
										<div class="text-right">
											<button type="submit" class="btn btn-primary" name="appointment">Submit</button>
										</div>
										...
										<?php
											...
											{
												echo '<script type="text/javascript"> alert("Appointment Recieved. Thank you!")</script>';
											}
