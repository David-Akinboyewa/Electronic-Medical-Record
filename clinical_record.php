<?php include('server.php');
	...
	if (isset($_POST['clinical-submit'])) {
			...
			$sql_status = "SELECT hosp_number FROM clinical_records_tb WHERE hosp_number = '$hospitalnumber_var' ";
			...
			//ensure that hospital number is entered into the form fields.
				...
				if ($row > 1 ) {
					...
					$insert_clinical = "INSERT INTO clinical_records_tb ( date_of_presentation, firstname, lastname, hosp_number, address, phonenumber, age, gender, source_of_referral, presenting_compliant, hpc , examination, diagnosis, diagnosis_two, available_investigations, requested, plan, secondvisit, thirdvisit ) VALUES ( '$datepre_var', '$firstname_var', '$lastname_var', '$hospitalnumber_var', '$address_var','$phonenumber_var', '$age_var','$gender_var', '$sourceofreferral_var', '$presentingcompliant_var', '$hpc_var', '$examination_var', '$diagnosis_var' , '$diagnosis_two_var' , '$availableinvestigations_var', '$requested_var', '$plan_var', '$secondvisit_var', '$thirdvisit_var' )";
					$query_run = mysqli_query($db, $insert_clinical);

						if($query_run) {
							echo '<script type="text/javascript"> alert("Clinical Information Saved")</script>';
						}else
							{
								echo '<script type="text/javascript"> alert("CLinical Information Not Saved")</script>';
							}
        ...
        <div class="main-wrapper">
            ...
            <div class="header">
                ...
                <div class="header-left">
                    <a href="clinical_record.php" class="logo">
						...
						<ul>
							...
							<li class="active">
								...
								<ul style="display: none;">
									...
									<li><a href="update_clinical.php">Update Clinical Record</a></li>
								</ul>
							</li>
							<li class="submenu">
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">Clinical Record</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item active">Clinical Record</li><li class="breadcrumb-item active"><a href="update_clinical.php"  style="color:red;">Update Clinical Record</a></li><li class="breadcrumb-item active"><a href="add_patient_record.php" style="color:red;">Back</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card">
								...
								<div class="card-body">
									<form action="clinical_record.php" method="post">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" placeholder="" name="sourceofreferral">
										</div>
										<div class="form-group">
											<label>Presenting Compliant</label>
											<input type="text" class="form-control" placeholder="" name="presentingcompliant">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" placeholder="" name="examination">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="availableinvestigations">
										</div>
										<div class="form-group">
											<label>Requested</label>
												<input type="text" class="form-control" placeholder="" name="requested">
										</div>
										<div class="form-group">
											<label>Plan</label>
										...
										<div class="form-group">
											<label>2nd Visit</label>
												<textarea type="text" class="form-control" placeholder=" " name="secondvisit"> </textarea>
										</div>
										<div class="form-group">
											<label>3rd Visit</label>
												<textarea type="text" class="form-control" placeholder=" " name="thirdvisit"> </textarea>
										</div>
										<div class="text-center">
											<button type="submit" class="btn btn-primary" name="clinical-submit">Submit</button>
										</div>	
