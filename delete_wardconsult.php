...
//	}
	...
	if(isset($_POST['search-button'])){
			...
			$id_Wardconsult_var = mysqli_real_escape_string($db, $_POST['id_Wardconsult']);
			...
			$query_unoperated =("DELETE FROM  ward_consult_records_tb WHERE hosp_number = '$hospitalnumber_unoperated_var' AND 	id_ward_consult  = '$id_Wardconsult_var' ")  or die("could not search");
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">Wardconsult Record</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item active" style="color:orange; font-size:20px ;">Delete <?php echo$hospitalnumber_var?> :: <?php echo$firstname_var ?> <?php echo$lastname_var ?> from Wardconsult Record</li><li class="breadcrumb-item active"><li ><mark><a href="patient-records.php" style="border-line:5px; color: green; border: 1px;" >Back</a></mark></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="row filter-row">
							<div class="col-sm-6 col-md-3">  
								<div class="form-group form-focus">
									<input type="text" class="form-control floating" name="id_Wardconsult" value="<?php echo$id_var ?>">
