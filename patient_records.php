								...
								<div class="main-search">
									<form action="patient_records.php" method="post">
										<div class="input-group">
											<input type="text" class="form-control" placeholder="enter patient name or Hospital number" name="search">
						...
						<div class="col-sm-12">
							<div class="card mb-0">
								<div class="card-header">
									<h4 class="card-title mb-0">Patient Record</h4>
									<p class="card-text">
								...
								<div class="card-body">
									<div class="table-responsive">
										<table class="datatable table table-stripped mb-0">
											...
											<?php
											$search_var = "";
											$table_var = "appointment_tb";

											if(isset($_POST['search-button'])){

											$search_var = mysqli_real_escape_string($db, $_POST['search']);
											$query = ("SELECT * FROM  $table_var WHERE appemail LIKE '%$search_var%' OR pname LIKE '%$search_var%' OR symptoms LIKE '%search_var%' " ) or die("could not search");
											...
											$queryResult = mysqli_num_rows($result);
													...
													if ($queryResult > 0 ) {
														while($row = mysqli_fetch_assoc($result)){
															...
															echo "<td>"; echo $row["appemail"]; echo"</td>";
